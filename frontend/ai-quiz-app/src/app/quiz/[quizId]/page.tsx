...
// import { Lightbulb, Video, Mic, CheckCircle, X, Clock, HelpCircle, ArrowLeft } from 'lucide-react'
...
//     //               <span>You are being monitored throughout the test</span>
//     //             </li>
//     //             <li className="flex items-start gap-2">
//     //               <div className="w-1.5 h-1.5 bg-amber-600 rounded-full mt-1.5 flex-shrink-0"></div>
//     //               <span>Malpractice will be detected and may lead to disqualification</span>
//     //             </li>
//     //             <li className="flex items-start gap-2">
//     //               <div className="w-1.5 h-1.5 bg-amber-600 rounded-full mt-1.5 flex-shrink-0"></div>
...
//     //                 <div
//     //                   key={i}
//     //                   className={`w-1.5 rounded-full transition-all duration-100 ${i < audioLevel * 20
//     //                     ? 'bg-green-500'
//     //                     : 'bg-gray-300'
//     //                     }`}
//     //                   style={{
...
//                       onChange={(e) => setQuizData({...quizData,questionsCount:Number(e.target.value)})}
...
//                         className={`flex-1 px-3 py-2 rounded-lg border transition-colors ${timerEnabled
...
//                         disabled={isSaved}
//                         size="sm"
//                         className={`flex items-center gap-1 ${isSaved ? "bg-green-600 hover:bg-green-700" : "bg-blue-600 hover:bg-blue-700"
//                           }`}
//                       >
...
//                 {/* Timer Options - Only show when timer is enabled */}
//                 {timerEnabled && (
//                   <div className="mt-4 space-y-3">
//                     <div className="flex gap-2">
//                       <button
//                         onClick={() => setTimerType("total")}
//                         className={`flex-1 px-3 py-2 rounded-lg border transition-colors ${timerType === "total"
//                             ? "bg-blue-100 border-blue-500 text-blue-700"
//                             : "bg-gray-100 border-gray-300 text-gray-700"
//                           }`}
//                       >
...
//                         className={`flex-1 px-3 py-2 rounded-lg border transition-colors ${timerType === "perQuestion"
//                             ? "bg-blue-100 border-blue-500 text-blue-700"
//                             : "bg-gray-100 border-gray-300 text-gray-700"
//                           }`}
//                       >
...
//                           className={`px-3 py-2 rounded-lg border transition-colors ${selectedTime === time
//                               ? "bg-blue-600 border-blue-600 text-white"
//                               : "bg-white border-gray-300 text-gray-700 hover:bg-gray-50"
//                             }`}
//                         >
//                           {time} {timerType === "total" ? "min" : "sec"}
//                         </button>
//                       ))}
//                     </div>
//                   </div>
...
//                 <div className="bg-blue-50 rounded-xl p-4 text-center border border-blue-100">
//                   <HelpCircle className="h-6 w-6 text-blue-600 mx-auto mb-2" />
//                   <div className="text-xl font-bold text-blue-600">{questionsCount}</div>
//                   <div className="text-sm text-blue-800 font-medium">Questions</div>
//                 </div>
...
//                       {selectedTime} {timerType === "total" ? "min" : "sec"}/q
//                     </div>
...
//             {/* Existing warning section remains the same */}
//             <div className="bg-amber-50 rounded-2xl border border-amber-200 p-6">
//               <div className="flex items-center gap-3 mb-4">
//                 <div className="p-2 bg-amber-100 rounded-lg">
//                   <Lightbulb className="h-5 w-5 text-amber-600" />
...
//           {/* Right sidebar remains exactly the same */}
//           <div className="space-y-6">
//             <div className="bg-white rounded-2xl shadow-sm border p-6">
//               <div className="flex items-center justify-between mb-4">
//                 <h3 className="text-lg font-semibold text-gray-900">Camera</h3>
...
//                     <div
//                       key={i}
//                       className={`w-1.5 rounded-full transition-all duration-100 ${i < audioLevel * 20 ? 'bg-green-500' : 'bg-gray-300'
//                         }`}
//                       style={{
//                         height: `${Math.max(4, (i + 1) * 2)}px`
//                       }}
                ...
                <div className="flex items-center gap-3">
                  ...
                  >
                    <div className={`absolute top-1 w-5 h-5 bg-white rounded-full transition-all duration-300 shadow-lg ${
                      timerEnabled ? 'transform translate-x-7' : 'transform translate-x-1'
                    }`} />
                  </button>
